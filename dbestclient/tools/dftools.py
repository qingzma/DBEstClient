...
def get_group_count_from_file(file, group_attr,sep=',', headers=None):
    df = pd.read_csv(file,sep=sep, dtype={group_attr: object}, keep_default_na=False,header=None, names=headers)
