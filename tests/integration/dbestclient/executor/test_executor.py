...
class TestTpcDs(unittest.TestCase):
    ...
    def test_simple_model(self):
        ...
        sqlExecutor.execute(
            "create table test_ss40g_sm(ss_sales_price real, ss_sold_date_sk real) from 'data/tpcds/40G/ss_1k.csv'  method uniform size 6000")  # scale data num_of_points2.csv
    ...
    def test_plot(self):
        ...
        sqlExecutor.execute(
            # data/tpcds/10g/ss_10g_100.csv
            "create table test_plot(ss_sales_price real, ss_sold_date_sk real) from 'data/tpcds/10g/ss_10g_1k.csv' GROUP BY ss_store_sk method uniform size 2000"
        )
        results = sqlExecutor.execute(
