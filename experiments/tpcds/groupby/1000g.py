...
class Query1:
    ...
    def build_model(self, mdl_name: str = "ss_1t"):
        ...
        self.sql_executor.execute("create table "+"ss1000g_onehot_30"+"(ss_sales_price real, ss_sold_date_sk real) from '../data/tpcds/1t/ss_1t_5m.csv' GROUP BY ss_store_sk method uniform size 'num_points/ss_1t.csv' ")
        ...
        self.sql_executor.execute("create table "+"ss1000g_embedding_30"+"(ss_sales_price real, ss_sold_date_sk real) from '../data/tpcds/1t/ss_1t_5m.csv' GROUP BY ss_store_sk method uniform size 'num_points/ss_1t.csv' ")


    def workload(self, result2file: str = '/home/u1796377/Documents/workspace/DBEstClient/experiments/results/mdn/1t/', n_jobs=1):
