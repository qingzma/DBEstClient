...
def compare_dicts(true: dict, pred: dict) -> dict:
    ...
    for key in true:
        ...
        # res.append(abs(((true[key]-pred[key]))))
        # print(key)
    # print(res)
    # plt.hist(res,bins=50)
    # plt.show()
    if cnt!=0:
        print(cnt," out of ",len(true), " missing groups")
    return res



def plt_workload( b_plot=True, b_merge_result_for_group=False, b_two_methods=False):
    mdn_errors = []
    kde_errors = []
    # prapare the files.
    ...
    mdn = read_results("experiments/huawei/result/q1_p20.txt")
    truth = read_results("experiments/huawei/result/q1.txt")  #, split_char=","
